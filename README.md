...
- depot/verif/sim$ source setup-env.sh
  
- Dans: depot/verif/sim lancer la commande de test, changer le test cible dans la commande ici : /tests/custom/hello_world/?.c    
